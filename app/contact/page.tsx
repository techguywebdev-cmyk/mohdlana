      ...
      <PageIntro
        ...
        title={
          <>
            Come say hello on
            <br />
            <span className="italic text-bloom-500">Eduardo Mohdlana Road.</span>
          </>
        }
        description="Questions, feedback, or just want to chat? We're here for you, Monday through Friday."
        ...
        badge={{ label: 'Response time', text: 'We reply within one business day.' }}
      />

      <section className="container-page grid gap-6 pb-12 pt-12 sm:grid-cols-2 lg:grid-cols-4">
        {info.map((i) => (
