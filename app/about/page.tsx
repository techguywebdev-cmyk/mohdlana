  ...
  return (
    <>
      <section className="container-page pb-16 pt-12">
        <p className="eyebrow">About Mohdlana</p>
        <h1 className="mt-4 max-w-3xl text-4xl font-semibold leading-tight sm:text-5xl">
          A school built on the idea that children learn best with their hands, their voices and their whole hearts.
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-ink/70">
          Mohdlana Preschool sits on Eduardo Mohdlana Road in Lartebiokorshie, Accra — a safe, dynamic and vibrant
          school community nurturing well-rounded, confident and curious critical thinkers through experiential
          learning, from our youngest Creche learners to our Kindergarten graduates.
        </p>
      </section>
