...
import { SparkleDoodle, StarDoodle, HeartDoodle } from '@/components/Doodles';
      ...
      <section className="bg-paper-warm pb-20 pt-8">
        <div className="container-page">
          ...
          <div className="mt-16 space-y-16">
            {/* Row 1: Experiential Learning — real photo, image left */}
            <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
              <div className="relative mx-auto w-full max-w-sm">
                <span className="pointer-events-none absolute -left-3 -top-4 text-teal-500">
                  <SparkleDoodle className="h-8 w-8" />
                </span>
                <div className="relative -rotate-2 rounded-blob border-[6px] border-white bg-white shadow-card">
                  <div className="relative aspect-[4/3] overflow-hidden rounded-blob">
                    <Image
                      src="/images/back-to-school.jpg"
                      alt="A Mohdlana Preschool learner arriving for their first day of school"
                      fill
              ...
              <div className="text-center lg:text-left">
                <PillarIcon name={pillars[0].icon} tone="teal" />
                <h3 className="mt-4 font-display text-2xl font-semibold text-ink">{pillars[0].title}</h3>
                <p className="mt-2 max-w-sm text-sm leading-relaxed text-ink/65 lg:mx-0 mx-auto">{pillars[0].description}</p>
              </div>
            </div>

            {/* Row 2: Screen-Free STEM — icon panel, image right */}
            <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
              <div className="text-center lg:order-1 lg:text-left">
                <PillarIcon name={pillars[1].icon} tone="sun" />
                <h3 className="mt-4 font-display text-2xl font-semibold text-ink">{pillars[1].title}</h3>
                <p className="mt-2 max-w-sm text-sm leading-relaxed text-ink/65 lg:mx-0 mx-auto">{pillars[1].description}</p>
              </div>
              <div className="relative mx-auto w-full max-w-sm lg:order-2">
                <span className="pointer-events-none absolute -right-2 -top-5 text-sun-500">
                  <StarDoodle className="h-7 w-7" />
                </span>
                <div className="relative rotate-2 rounded-blob border-[6px] border-white bg-sun-50 shadow-card">
                  <div className="flex aspect-[4/3] items-center justify-center rounded-blob text-sun-500">
                    <SparkleDoodle className="h-16 w-16" />
                  </div>
                </div>
              </div>
            </div>

            {/* Row 3: Global Citizens — real photo, image left */}
            <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
              <div className="relative mx-auto w-full max-w-sm">
                <span className="pointer-events-none absolute -left-4 -bottom-4 text-bloom-400">
                  <HeartDoodle className="h-7 w-7" />
                </span>
                <div className="relative -rotate-1 rounded-blob border-[6px] border-white bg-white shadow-card">
                  <div className="relative aspect-[4/3] overflow-hidden rounded-blob">
                    <Image
                      src="/images/heritage-ghana.jpg"
                      alt="Mohdlana Preschool learners in Ghanaian kente holding the Ghana flag"
                      fill
                      sizes="(max-width: 1024px) 90vw, 40vw"
                      className="object-cover"
                    />
              ...
              <div className="text-center lg:text-left">
                <PillarIcon name={pillars[2].icon} tone="bloom" />
                <h3 className="mt-4 font-display text-2xl font-semibold text-ink">{pillars[2].title}</h3>
                <p className="mt-2 max-w-sm text-sm leading-relaxed text-ink/65 lg:mx-0 mx-auto">{pillars[2].description}</p>
              </div>
            </div>
          </div>

          {/* Remaining pillars — compact secondary row */}
          <div className="mt-16 grid gap-8 border-t border-ink/8 pt-12 text-center sm:grid-cols-3">
            {pillars.slice(3).map((p, i) => {
              ...
              return (
                <div key={p.title} className="flex flex-col items-center">
                  <PillarIcon name={p.icon} tone={tones[i % tones.length]} />
      ...
      <section className="relative overflow-hidden bg-paper-warm py-20">
        ...
        <div className="container-page relative grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative grid grid-cols-2 gap-4">
            <div className="relative aspect-[3/4] overflow-hidden rounded-photo shadow-card">
            ...
            <div className="relative mt-10 aspect-[3/4] overflow-hidden rounded-photo shadow-card">
