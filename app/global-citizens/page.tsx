      ...
      <PageIntro
        ...
        title={
          <>
            Proud of home first —
            <br />
            <span className="italic text-bloom-500">curious about the world</span> always.
          </>
        }
        description="Once a term, our Heritage & Culture Day turns every classroom into a passport stamp. Children dress in traditional attire, taste new foods, learn a handful of words in a new language, and present what makes a culture special — starting always with pride in being Ghanaian."
        primaryCta={{ label: 'Book a tour', href: '/admissions#enquire' }}
        image={{ src: '/images/heritage-france.jpg', alt: 'Mohdlana Preschool learners in French traditional attire holding the France flag' }}
        badge={{ label: 'Heritage Day', text: 'A new passport stamp every term.' }}
      />
