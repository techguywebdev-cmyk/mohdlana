    ...
    <>
      <section className="container-page pb-12 pt-12">
        ...
        <h1 className="mt-4 max-w-2xl text-4xl font-semibold leading-tight sm:text-5xl">
          Your family&apos;s place at Mohdlana starts with a conversation.
        </h1>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink/70">
          We keep our classes small, so enrolment windows can close early. Reach out as soon as you&apos;re
          considering us — there&apos;s no pressure, only answers.
        </p>
      </section>
